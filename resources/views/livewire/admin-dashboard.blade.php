<div class="grid w-full gap-8 p-8 xl:p-8 2xl:p-10 xl:gap-8 2xl:gap-10">

    <div class="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-4 xl:gap-8 2xl:gap-10">
        <x-board color="blue-500" name="total users" digit="{{ random_int(100, 1000) }}">
            <svg xmlns="http://www.w3.org/2000/svg" class="w-8 h-8 2xl:w-10 2xl:h-10" fill="currentColor"
        ...
        <x-board color="red-500" name="Books" digit="{{ random_int(50, 10000) }}">

            <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor"
                class="w-8 h-8 bi bi-journal-richtext 2xl:w-10 2xl:h-10" viewBox="0 0 16 16">
                <path
        ...
        <x-board color="green-600" name="sales" money="{{ true }}"
            digit="{{ moneyFormat(random_int(50000, 1000000)) }}">
            <svg xmlns="http://www.w3.org/2000/svg" class="w-8 h-8 2xl:w-10 2xl:h-10" fill="currentColor"
        ...
        <x-board color="gray-500" name="performance"
            digit="{{ performance(random_int(50000, 1000000), random_int(50000, 1000000)) }}">
            <svg xmlns="http://www.w3.org/2000/svg" class="w-8 h-8 2xl:w-10 2xl:h-10" fill="currentColor"
