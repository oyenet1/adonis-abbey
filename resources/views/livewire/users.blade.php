<div class="flex flex-col w-full gap-6 py-8 lg:py-12">
    ...
    <x-modal class="max-w-lg">
        <x-form title="user" :update="$update">
            ...
            <x-text-input label="Telephone*" name="phone" type="text" wire:model.defer="phone" />
            {{-- email --}}
                        ...
                        <td class="p-2 whitespace-nowrap">
                            <div class="flex space-x-2 item-center">
                                <a href="tel:+234{{ str_replace('-', '', $user->phone) }}"
                                    class="w-8 h-8 p-2 text-green-600 border border-green-600 rounded-lg tt hover:-translate-y-1">
                                ...
                                <span wire:click="edit({{ $user->id }})"
                                    class="w-8 h-8 p-2 text-blue-600 border border-blue-600 rounded-lg cursor-pointer tt hover:-translate-y-1">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                ...
                                <span wire:click="confirmDelete({{ $user->id }})"
                                    class="w-8 h-8 p-2 text-red-600 border border-red-600 rounded-lg cursor-pointer tt hover:-translate-y-1">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
