        ...
        <aside class="aside is-placed-left is-expanded border-r bg-white ">
            ...
            <div class="absolute w-full bottom-0 mx-auto rounded-lg flex mb-4 justift-between items-center">
                <img src="/img/adonis.png" alt="Adonis and abbey publishers"
                    class="block lg:w-40 animate w-24 p-4 border-4 rounded-lg border-primary mx-auto">
            </div>
        </aside>
                ...
                <div class="card">
                    <div class="card-content">
                        <div class="flex items-center justify-between">
                            ...
                            <span class="text-green-500 icon widget-icon"><i
                ...
                <div class="card">
                    <div class="card-content">
                        <div class="flex items-center justify-between">
                            ...
                            <span class="text-blue-500 icon widget-icon"><i
                ...
                <div class="card">
                    <div class="card-content">
                        <div class="flex items-center justify-between">
                            ...
                            <span class="text-red-500 icon widget-icon"><i
                    ...
                    <div class="chart-area">
                        <div class="h-full">
                            ...
                            <canvas id="big-line-chart" width="2992" height="1000"
                                class="block chartjs-render-monitor" style="height: 400px; width: 1197px"></canvas>
                        </div>
                    </div>
                </div>
            </div>
