    ...
    <div id="app" class="relative">
        ...
        <aside class="overflow-y-auto bg-white border-r aside is-placed-left is-expanded">
            <div class="aside-tools bg-primary-light">
                <div class="mx-auto font-black text-center uppercase text-primary">Adonis -<b class="font-black text-secondary">
                        Abbey</b>
                </div>
            </div>
            <div class="space-y-1 overflow-y-auto menu is-menu-main">
                ...
                <ul class="space-y-1 menu-list">
                    <li>
                        ...
                        <ul class="bg-white ">
                            <li class=" {{ request()->is('admin/users') ? 'bg-secondary border-l-2 border-transparent' : 'bg-white' }}">
